                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-[600px]">
                    <div className="md:col-span-2">
                        <BentoCard
                            ...
                            value="Professional"
                            subtitle="Create and send beautiful proposals that close deals faster"
                    ...
                    <BentoCard
                        title="Client Portal"
                        value="Organized"
                        subtitle="Keep all clients in one place"
                    ...
                    <div className="md:col-span-2">
                        <BentoCard
                            ...
                            value="Automated"
                            subtitle="Generate invoices automatically and track payment status in real-time"
                    ...
                    <div className="md:col-span-3">
                        <BentoCard
                            ...
                            value="Detailed"
                            subtitle="Track billable hours and generate comprehensive reports for your clients"
